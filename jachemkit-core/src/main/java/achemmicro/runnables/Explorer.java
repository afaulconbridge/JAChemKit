...
/**
 * Simple molecule explorer. From a reactor and some intial molecules, it tries every possible combination
 * of reactants. This is probably too space inefficient and too slow to be practical, but is a nice easy system to start with. 
 * 
 * @author Adam
 *
 */
public class Explorer {
	...
	public static void main(String[] args) {
		...
		/*
		 * molecularSpecies.add(new MoleculeBuilder<String>().fromElement(0, 0,
		 * "F").build()); molecularSpecies.add(new
		 * MoleculeBuilder<String>().fromElement(0, 0, "G").build());
		 * molecularSpecies.add(new MoleculeBuilder<String>().fromElement(0, 0,
		 * "H").build()); molecularSpecies.add(new
		 * MoleculeBuilder<String>().fromElement(0, 0, "I").build());
		 * molecularSpecies.add(new MoleculeBuilder<String>().fromElement(0, 0,
		 * "J").build()); molecularSpecies.add(new
		 * MoleculeBuilder<String>().fromElement(0, 0, "K").build());
		 * molecularSpecies.add(new MoleculeBuilder<String>().fromElement(0, 0,
		 * "L").build()); molecularSpecies.add(new
		 * MoleculeBuilder<String>().fromElement(0, 0, "M").build());
		 * molecularSpecies.add(new MoleculeBuilder<String>().fromElement(0, 0,
		 * "N").build()); molecularSpecies.add(new
		 * MoleculeBuilder<String>().fromElement(0, 0, "O").build());
		 * molecularSpecies.add(new MoleculeBuilder<String>().fromElement(0, 0,
		 * "P").build()); molecularSpecies.add(new
		 * MoleculeBuilder<String>().fromElement(0, 0, "Q").build());
		 * molecularSpecies.add(new MoleculeBuilder<String>().fromElement(0, 0,
		 * "R").build()); molecularSpecies.add(new
		 * MoleculeBuilder<String>().fromElement(0, 0, "S").build());
		 * molecularSpecies.add(new MoleculeBuilder<String>().fromElement(0, 0,
		 * "T").build()); molecularSpecies.add(new
		 * MoleculeBuilder<String>().fromElement(0, 0, "U").build());
		 * molecularSpecies.add(new MoleculeBuilder<String>().fromElement(0, 0,
		 * "V").build()); molecularSpecies.add(new
		 * MoleculeBuilder<String>().fromElement(0, 0, "W").build());
		 * molecularSpecies.add(new MoleculeBuilder<String>().fromElement(0, 0,
		 * "X").build()); molecularSpecies.add(new
		 * MoleculeBuilder<String>().fromElement(0, 0, "Y").build());
		 * molecularSpecies.add(new MoleculeBuilder<String>().fromElement(0, 0,
		 * "Z").build());
		 */
